...
<head>
  ...
  <!-- CSS PERSO -->
  <link rel="stylesheet" href="../admin/starter.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Home<div class="mbborder" ></div></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Contact<div class="mbborder" ></div></a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php  echo  $_SESSION["user_prenom"];?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../login/logout.php" class="nav-link">
              ...
              <p>
                <span class="badge badge-danger">Log out </span>
              </p>
            </a>
          </li>
        </ul>
  ...
  <!-- Main Footer -->
  <footer class="main-footer footerm">
    <!-- To the right -->
